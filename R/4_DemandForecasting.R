...
# TODO:  Filtering the data set in the p_year_seasonality visual and sales_forecast_date data frame is a short term fix. 
#        If we were to implement this we would need to come up with a better fix.
#
# FYI:   If you want to edit your the code I recommend that you use R Studio and the distribution of R from MRAN. You
#        can download the R Studio IDE here:  https://www.rstudio.com/products/rstudio/download/. You can download the most
#        recent version of Microsoft R Open for MRAN here:  https://mran.microsoft.com/. You can get instructions on 
#        how to setup Power BI to use R from "Guy in a Cube" here:  https://www.youtube.com/watch?v=NomSliJK3s4.
library(tidyverse)
library(ggthemes)
library(lubridate)
library(scales)
